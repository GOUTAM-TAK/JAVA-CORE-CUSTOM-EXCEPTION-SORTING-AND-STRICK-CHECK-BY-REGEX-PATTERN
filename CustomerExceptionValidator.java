...
public class CustomerExceptionValidator {
	...
	public static Customer validateAll(String firstName, String lastName, String email, String passsword, double registrationAmount,String dobDate, String plan,List<Customer> customerList) throws CustomerCustomExceptions,InterruptedException,DateTimeParseException
	{
